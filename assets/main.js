...
function obradaForme(){
    ...
    let regIzrazPrezime = /^[A-ZŠĐŽČĆ][a-zšđčćž]{2,19}$/;

    //provera unosa
    provera(regIzrazIme, objIme, "Ime mora sadržati minimum 3 karaktera, a maksimum 20.<br/> Primer: Aleksandar");
    provera(regIzrazPrezime, objPrezime, "Prezime mora sadržati minimum 3 karaktera, a maksimum 20.<br/> Primer: Kandić");
